package com.tagme.presentation.views
    ...
    private var visible: Boolean
        ...
        set(value) {
            if (_visible != value) {
                _visible = value
                if (_visible) {
                    animateSizeChange(if (isFocusedOn) 150 else 100)
                } else {
                    animateSizeChange(0)
                }
            }
        ...
        point?.let {
            ...
            if (storyId == 0) {
                ...
                if (currentSpeed != null && currentSpeed.toInt() != 0) {
                    val speedText = resources.getString(R.string.speed_format, (currentSpeed * 3.6).toInt())
                    canvas.drawText(
                        speedText,
                        it.x.toFloat(),
